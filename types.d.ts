import { DailyFatalErrorType, DailyNonFatalErrorType } from '@daily-co/daily-js';
...
export type RTCStatsReportStat = RTCIceCandidatePairStats[] | RTCInboundRtpStreamStats;
